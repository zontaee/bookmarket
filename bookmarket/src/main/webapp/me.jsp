...
<nav class="navbar navbar-expand-sm bg-light">
      <ul class="navbar-nav">
        ...
        <li class="nav-item"  id="mynavbar2-2">
          <a class="nav-link text-dark" href="http://localhost:8080/WebMarket_book/wel.jsp?#best">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="http://localhost:8080/WebMarket_book/wel.jsp?#new">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="http://localhost:8080/WebMarket_book/wel.jsp?#recommend">
